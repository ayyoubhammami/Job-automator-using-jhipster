...
import { FreelancerDetailsComponent } from 'app/entities/freelancer-details/freelancer-details.component';
...
describe('Component Tests', () => {
    describe('FreelancerDetails Management Component', () => {
        let comp: FreelancerDetailsComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(FreelancerDetailsComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new FreelancerDetails(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.freelancerDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
