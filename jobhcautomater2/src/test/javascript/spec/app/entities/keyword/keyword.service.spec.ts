...
describe('Service Tests', () => {
    describe('Keyword Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(KeywordService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/keywords';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Keyword', () => {
                service.create(new Keyword(null)).subscribe(received => {
            ...
            it('should update a Keyword', () => {
                service.update(new Keyword(123)).subscribe(received => {
