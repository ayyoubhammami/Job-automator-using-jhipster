...
import { CompaignComponent } from 'app/entities/compaign/compaign.component';
...
describe('Component Tests', () => {
    describe('Compaign Management Component', () => {
        let comp: CompaignComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CompaignComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.compaigns[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
