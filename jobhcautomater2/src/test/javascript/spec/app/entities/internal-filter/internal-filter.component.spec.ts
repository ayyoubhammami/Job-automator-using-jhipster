...
import { InternalFilterComponent } from 'app/entities/internal-filter/internal-filter.component';
...
describe('Component Tests', () => {
    describe('InternalFilter Management Component', () => {
        let comp: InternalFilterComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(InternalFilterComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.internalFilters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
