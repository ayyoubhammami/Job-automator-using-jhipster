...
import { EmployeeDetailsComponent } from 'app/entities/employee-details/employee-details.component';
...
describe('Component Tests', () => {
    describe('EmployeeDetails Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.employeeDetails[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
