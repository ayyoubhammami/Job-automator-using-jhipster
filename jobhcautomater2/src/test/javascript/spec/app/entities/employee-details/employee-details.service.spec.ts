...
describe('Service Tests', () => {
    describe('EmployeeDetails Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EmployeeDetailsService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/employee-details';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EmployeeDetails', () => {
                service.create(new EmployeeDetails(null)).subscribe(received => {
            ...
            it('should update a EmployeeDetails', () => {
                service.update(new EmployeeDetails(123)).subscribe(received => {
            ...
            it('should return a EmployeeDetails', () => {
            ...
            it('should return a list of EmployeeDetails', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EmployeeDetails(123)]);
            });
