...
describe('Service Tests', () => {
    describe('Affectation Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AffectationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/affectations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Affectation', () => {
                service.create(new Affectation(null)).subscribe(received => {
            ...
            it('should update a Affectation', () => {
                service.update(new Affectation(123)).subscribe(received => {
            ...
            it('should return a Affectation', () => {
