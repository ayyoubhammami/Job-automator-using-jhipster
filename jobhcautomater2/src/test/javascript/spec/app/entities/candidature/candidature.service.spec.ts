...
describe('Service Tests', () => {
    describe('Candidature Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CandidatureService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/candidatures';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Candidature', () => {
                service.create(new Candidature(null)).subscribe(received => {
            ...
            it('should update a Candidature', () => {
                service.update(new Candidature(123)).subscribe(received => {
            ...
            it('should return a Candidature', () => {
