    ...
    describe('SocialMedia Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a SocialMedia', () => {
                service.create(new SocialMedia(null)).subscribe(received => {
            ...
            it('should update a SocialMedia', () => {
                service.update(new SocialMedia(123)).subscribe(received => {
            ...
            it('should return a SocialMedia', () => {
