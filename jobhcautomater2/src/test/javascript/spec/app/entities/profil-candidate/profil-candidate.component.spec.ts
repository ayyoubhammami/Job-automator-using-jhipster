...
import { ProfilCandidateComponent } from 'app/entities/profil-candidate/profil-candidate.component';
...
describe('Component Tests', () => {
    describe('ProfilCandidate Management Component', () => {
        let comp: ProfilCandidateComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProfilCandidateComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.profilCandidates[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
