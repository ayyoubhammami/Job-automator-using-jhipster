...
public class EmailResourceIntTest {
    ...
    private static final EmailingCategory DEFAULT_CATEGORY = EmailingCategory.JOB;
    private static final EmailingCategory UPDATED_CATEGORY = EmailingCategory.NEWS;
    ...
    public void createEmail() throws Exception {
        ...
        assertThat(testEmail.getProfession()).isEqualTo(DEFAULT_PROFESSION);
        assertThat(testEmail.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testEmail.getCategory()).isEqualTo(DEFAULT_CATEGORY);
    }
    ...
    public void updateEmail() throws Exception {
        ...
        assertThat(testEmail.getProfession()).isEqualTo(UPDATED_PROFESSION);
        assertThat(testEmail.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testEmail.getCategory()).isEqualTo(UPDATED_CATEGORY);
    }
