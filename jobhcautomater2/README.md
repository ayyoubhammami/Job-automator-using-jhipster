...
To optimize the JobHCAutomater2 application for production, run:
...
ok
first test
2nd commit by hammami
3rd commit
4em commit
branch 'master' of http://gitlab.huge-coders.com/Ayoub.Hammami/jee-coaching
